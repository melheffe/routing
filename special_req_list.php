...
<table width="473" height="16" border="0" align="center" cellpadding="0" cellspacing="0" class="text">
  <tr>
    <td width="55"><form action="special_req_add.php" method="post" name="form1" target="_self" id="form1">
      <input type="submit" name="New" id="New" value="New" />
    </form></td>
    <td width="418" class="titulos"><span class="style3">Special Requirements</span></td>
  </tr>
</table>
<br />
  ...
  <tr>
    <td width="537"><table width="359" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#EBEBEB" class="text">
      ...
      <tr class="sobreblancopeq">
        ...
        <td width="96"><div align="center" class="style3 style100"><span class="style101"><?php echo "<a href='special_req_edit.php?special_req_id=".$row['special_req_id']."'>Edit</a>"; ?> / <?php echo "<a href='special_req_erase.php?special_req_id=".$row['special_req_id']."'>Erase</a>"; ?></span></div></td>
      </tr>
      <?php }?>
    </table></td>
  </tr>
